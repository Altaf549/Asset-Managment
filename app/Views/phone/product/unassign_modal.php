    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="unassignModalLabel">Unassign Phone</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="unassignPhoneBtn" onclick="unassignPhone()">Unassign</button>
            </div>
        </div>
    </div>
</div>
