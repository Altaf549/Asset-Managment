    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="unassignModalLabel">Unassign Laptop</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="unassignLaptopBtn" onclick="unassignLaptop()">Unassign</button>
            </div>
        </div>
    </div>
</div>
